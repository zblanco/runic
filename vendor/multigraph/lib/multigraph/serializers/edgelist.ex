defmodule Multigraph.Serializers.Edgelist do
  @moduledoc """
  This serializer converts a `Multigraph` to an edgelist suitable for using with
  ...
  @spec serialize(Multigraph.t()) :: {:ok, String.t()}
  def serialize(g) do
  ...
  @spec serialize_edges(Multigraph.t()) :: String.t()
  defp serialize_edges(%Multigraph{vertices: vertices, out_edges: oe} = g) do
